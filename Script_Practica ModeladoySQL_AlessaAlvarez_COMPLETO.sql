...
select c.dt_compra , d."name",b."name", a.matricula, e."name", a.num_kilometros,f."name", a.num_poliza
...
inner join alessamaster.aseguradoras f on a.aseguradora = f.aseguradora
